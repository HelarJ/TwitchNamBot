...
public enum Command {
     ...
     */
    Command(boolean onlineAllowed, boolean selfAllowed, boolean othersAllowed, boolean modsAllowed, boolean canOptOut) {
    ...
    public boolean isModsAllowed(String self, List<String> modList) {
        return modsAllowed && modList.contains(self);
    }

    public boolean isOptedOut(String username, List<String> optOutList) {
